            ...
            <div class="weui-cells weui-cells_radio">
                <label class="weui-cell weui-check__label" for="x11">
                    <div class="weui-cell__bd weui-media-box_appmsg">
                        <img style="width: 24px;margin-right: 12px;" src="{{asset('weui/images/card_pay_512x512.png')}}">
                        <div class="weui-media-box__bd">
                            <h4 class="weui-media-box__title fz13">年卡支付</h4>
                ...
                <div class="weui-tabbar">
                    <div class="weui-form-preview w100p">
                        <div class="weui-form-preview__ft">
                            <div class="weui-form-preview__btn weui-form-preview__btn_default fz11">
                                年卡到期时间：{{$user_list->vip_exp_at}}
                            </div>
